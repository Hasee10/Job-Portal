...
export function renderPasswordResetEmail({
  ...
  const html = wrapEmailBody(`
    ...
    <div style="padding: 40px 40px 36px;">
      ...
      <p style="margin: 0 0 28px; font-size: 15px; line-height: 1.65; color: #52525b;">We received a request to reset your Caliber employer account password. This link expires in 1 hour and can only be used once.</p>
