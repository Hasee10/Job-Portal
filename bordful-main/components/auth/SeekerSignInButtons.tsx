...
export function SeekerSignInButtons() {
  ...
  return (
    <div className="mx-auto w-full max-w-md rounded-2xl border border-zinc-200 bg-white p-8 shadow-md dark:border-zinc-800 dark:bg-zinc-900/60">
      <div className="space-y-3">
        <Button
          className="h-12 w-full gap-3 text-base transition-transform hover:-translate-y-0.5"
